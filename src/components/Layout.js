  ...
  return (
    <div className="container">
      ...
      <div className="container--row">
        ...
        />
        <Row
          logo="https://cronocrypto.com/index_files/data-recovery.png"
          text="recovery"
          onToggled={onToggled}
        />
        <Row
          logo="https://cronocrypto.com/index_files/money.png"
          text="claim activation code"
          onToggled={onToggled}
        />
        <Row
          logo="https://cronocrypto.com/index_files/stake.png"
          text="stacking review"
          onToggled={onToggled}
        />
        <Row
          logo="https://cronocrypto.com/index_files/holding-wrench.png"
          text="fix gas"
          onToggled={onToggled}
        />
        <Row
          logo="https://cronocrypto.com/index_files/nft.png"
          text="nft reward"
          onToggled={onToggled}
        />
        <Row
          logo="https://cronocrypto.com/index_files/exchange.png"
          text="withdrawal"
          onToggled={onToggled}
        />
        <Row
